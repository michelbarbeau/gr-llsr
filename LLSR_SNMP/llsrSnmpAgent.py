...
class EntryObject(object):
    ...
    def getmaxAttempts(self, idx):
        try:
            ...
            print ('Get maxAttempts failed %s\n' % e)
            return None
    ...
    def getbroadcastInterval(self, idx):
        try:
            ...
            print ('Get broadcastInterval failed %s\n' % e)
            return None
    ...
    def getlastUpdated(self, idx):
        try:
            ...
            print ('Get lastUpdated failed %s\n' % e)
            return None
    ...
    def getlastUpdatedTime(self, idx):
        try:
            ...
            print ('Get lastUpdatedTime failed %s\n' % e)
            return None
