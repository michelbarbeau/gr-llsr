...
MIB='LLSR-MIB'
# row structure
RowObject=collections.namedtuple('RowObject',['mibname', 'columnname', 'getColumn', 'setColumn'])
	...
	def __init__(self, mibObjects):	
		...
		(MibTable, MibTableRow, MibTableColumn, 
		 MibScalarInstance)= mibBuilder.importSymbols('SNMPv2-SMI',
                 'MibTable', 'MibTableRow', 'MibTableColumn', 'MibScalarInstance')
		#import and maintain Table
		maintaintable = maintainTableThread(0, mibObjects, mibBuilder, MibScalarInstance)
		maintaintable.start()
...
if __name__ == '__main__':
	...
	RowObject(MIB,'maxAttempts', entry.getmaxAttempts, entry.setmaxAttempts),
	RowObject(MIB,'broadcastInterval', entry.getbroadcastInterval, entry.setbroadcastInterval),
